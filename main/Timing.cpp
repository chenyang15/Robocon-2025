...
int timing_setup_check() {
    ...
    //     Serial.print("MAIN_LOOP_PERIOD (%d) is not a multiple of MOTOR_WHEEL_ACTUATION_PERIOD (%d)\n",
    ...
    //     Serial.print("MAIN_LOOP_PERIOD (%d) is not a multiple of MOTOR_WHEEL_ENCODER_PERIOD (%d)\n",
    ...
    //     Serial.print("MAIN_LOOP_PERIOD (%d) is not a multiple of MOTOR_WHEEL_ENCODER_TIME_OFFSET (%d)\n",
